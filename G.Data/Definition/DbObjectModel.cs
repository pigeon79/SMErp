...
using G.Data.SqlEntry.Dynamic;

namespace G.Data.Definition
{
    [Serializable]
    public class DbObjectModel<T> : DbObjectModel<T, int> where T : DbObjectModel<T, int>, new()
    {
    }
    ...
    public class DbObjectModel<T, TKey> : DbObjectSmartUpdate where T : DbObjectModel<T, TKey>, new() where TKey : struct
    {
        ...
        public override void setValue(string name, object value)
        {
            ...
            {
                this.GetType().GetProperty(name).SetValue(this, value, new object[] { });
            }
        }
    }
}
