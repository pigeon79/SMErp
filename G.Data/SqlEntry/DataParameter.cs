...
namespace G.Data.SqlEntry
{
	...
	public class DataParameter : KeyValue
	{
        ...
        public DataParameter(string key, object value,int size)
        ...
        public DataParameter(string key, object value, Type valueType,int size)
            : base(LegalKey(key), value, valueType)
        {
            SetTypeByObject(valueType);
            this.Size = size;
        ...
        public DataParameter(string key, object value, Type valueType, ParameterDirection direction,int size)
            : base(LegalKey(key), value, valueType)
        {
            SetTypeByObject(valueType);
            this.Direction = direction;
