...
namespace G.Data
{
    public static class DbEntry
    {
        ...
        //public static List<T> GetData<T>(string viewname, Condition iwc, OrderBy order) where T : class, IDbObject
        //{
        //    G.Data.Builder.Clause.FromClause _from = new Data.Builder.Clause.FromClause(viewname);
        //    SqlStatement ss= GetOperator(typeof(T)).Composer.GetSelectStatement(_from, iwc, order, null, true, false, typeof(T));
        //    return ExecuteList<T>(ss);
        //}
