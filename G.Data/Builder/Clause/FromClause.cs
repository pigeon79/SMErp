...
namespace G.Data.Builder.Clause
{
    public class FromClause : IClause
    {
        ...
        public readonly string MainViewName;
        ...
        public FromClause(string tableName, string viewName)
        {
        ...
        public FromClause(string modelName, string tableName, string viewName)
        {
