...
namespace G.Data.Builder
{
	public class SelectStatementBuilder : SqlStatementBuilder, IWhereClause, ISqlKeys, ISqlWhere
	{
		...
		public SelectStatementBuilder(string tableName,string viewName) : this(tableName,viewName, null, null)
		{
		}

        public SelectStatementBuilder(string tableName,string viewName, OrderBy order, Range limit)
            : this(new FromClause(tableName,viewName), order, limit)
		{
		}
