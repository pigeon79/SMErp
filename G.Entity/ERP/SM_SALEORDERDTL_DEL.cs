...
{
    [DbView("SM_SALEORDERDTL_DEL_V1")]
    public class SM_SALEORDERDTL_DEL : DbObjectModel<SM_SALEORDERDTL_DEL, int>
    {
        public SM_SALEORDERDTL_DEL()
        {
            //SALEORDERID = 0;
            ORDERID = "";
            ORDLNNO = 0;
        ...
        public SM_SALEORDER_DEL SALEORDER_DEL { get; set; }
        [Length(10), AllowNull]
