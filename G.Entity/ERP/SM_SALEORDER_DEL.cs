...
{
    [DbView("SM_SALEORDER_DEL_V1")]
    public class SM_SALEORDER_DEL : DbObjectModel<SM_SALEORDER_DEL, int>
    {
        public SM_SALEORDER_DEL()
        {
            ISSELECT = false;
            ORDERID = "";
        ...
        [HasMany(OrderBy = "ID")]
        public IList<SM_SALEORDERDTL_DEL> SALEORDERDTL_DEL { get; private set; }
