...
namespace G.BLL.Base
{
    ...
    {
        public static bool ValidateSave(Page p, IDbObject obj, Notice msg, string noticeText)
        {
            var vh = new ValidateHandler();
            return ValidateSave(p, vh, obj, msg, noticeText, "ErrInput");
        }

        public static bool ValidateSave(Page p, ValidateHandler vh, IDbObject obj, Notice msg, string noticeText, string cssErrInput)
        {
            return ValidateSave(p, vh, obj, msg, noticeText, cssErrInput, () => DbEntry.Save(obj));
        }

        public static bool ValidateSave(Page p, ValidateHandler vh, object obj, Notice msg, string noticeText,
