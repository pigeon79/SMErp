...
{
    public class DM_GXLogic : BaseBLL<DM_GX>, G.Interface.BLL.ISearch
    {
        public System.Data.DataTable SearchValue(Condition SearchCondition, string SearchText, string Fields, string ValueField)
        {
            ...
            if (!String.IsNullOrEmpty(SearchText))
            {
                ...
                {
                    c = CK.K["GXDM"].LeftLike(SearchText);
                    c |= CK.K["GXNAME"].Like(SearchText);
            ...
            return this.ExecuteSelect(c, OrderBy.Parse("GXDM"), 100, 0, ref allcount).ToDataTable();
        }
    }
}
