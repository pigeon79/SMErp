...
{
    public partial class SM_SALEORDERDELETED : G.APP.BaseForm.BaseEditor
    {
        public SM_SALEORDERDELETED()
        {
            InitializeComponent();
            InitInfo();
        }
        ...
        {
            this.listCaption = "销售订单撤销";
            this.listTool = new List<string>() { "撤销","退出" };
        ...
        private EditorAdapter<SM_SALEORDER, SM_SALEORDERDTL> initAdapter()
        {
            ...
            adapter.AddEditorInfo(new EditorInfo() { FieldCaption = "不开票", FieldName = "INVTAG", Editor = this.CHECK_INVTAG, IsReadOnly = true });
        ...
        private void DELETED()
        {
            try
            {
                SM_SALEORDER saleorderobj = this.editData as SM_SALEORDER;
